...
Begin VB.UserControl DarkComboBox 
   ...
   Begin VB.Timer tmrCheckFocus 
      ...
      Top             =   120
   End
   Begin ÍÏ¿Ø¼þ´ó·¨UI.DarkEdit edMain 
      Height          =   375
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    edMain.Text = PropBag.ReadProperty("Text", "Dark¡áComboBox")
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("Text", edMain.Text, "Dark¡áComboBox")
